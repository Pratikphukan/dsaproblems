...
import static com.dsaproblems.DSAProblems.linkedlist.MiddleElementOfLinkedList.findFirstMiddleOfLinkedList;
...
public class LinkedListFactory {
    ...
    public static ListNode sortLinkedList(ListNode node) {
        ...
        ListNode mid = findFirstMiddleOfLinkedList(node);
        ListNode h1 = null;
        ListNode h2 = null;
        h2 = mid.getNext();
        mid.setNext(null);
